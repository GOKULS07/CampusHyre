...
useEffect(() => {
  const data = {
    name, contact, email, address, branch, github, linkedin, leetcode,
    summary, events, education, projectList, achievementList,
    internshipList, volunteerList, coCurricularList,
    skills, interest, certification, tools, hobbies,
    skillList, interestList, eventList, certificationList, toolsList, hobbiesList
  };
...
const setters = {
  name: setName, contact: setContact, email: setEmail, address: setAddress, branch: setbranch,
  github: setGithub, linkedin: setLinkedin, leetcode: setleetcode, summary: setSummary,
  events: setEvents, education: setEducation, projectList: setProjectList,
  achievementList: setAchievementList, internshipList: setInternshipList,
  volunteerList: setVolunteerList, coCurricularList: setCoCurricularList,
  skills: setSkills, interest: setInterest, certification: setCertification, tools: setTools, hobbies: setHobbies,
  skillList: setSkillList, interestList: setInterestList, eventList: setEventList,
  certificationList: setCertificationList, toolsList: setToolsList, hobbiesList: setHobbiesList
};
  ...
  return (
    <div className="whole-container">
      ...
      <button onClick={clearResume} className="delete-button">Clear Resume</button>
    </div>
      {/* <Listcustom/> */}
